...
export const databases = [
  {
    name: "MySQL",
    description: "Base de datos relacional principal, índices optimizados y consultas complejas",
...
export const architecturePatterns: SkillGroup[] = [
  ...
  },
  {
    ...
    description: "Estrategias de caching, invalidación, query optimization y lazy loading",
    borderColor: "border-indigo-500",
  },
  {
...
export const toolSections: ToolSection[] = [
  {
    ...
    items: [
      {
        title: "Git & GitHub",
        description: "Control de versiones distribuido, pull requests y colaboración",
        borderColor: "border-purple-500",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "cPanel, shared hosting, VPS y configuración de servidores",
        borderColor: "border-yellow-500",
      },
    ],
  },
    ...
    items: [
      {
        ...
        description: "Integración con Shopify, WooCommerce, Prestashop y plataformas e-commerce",
        borderColor: "border-pink-500",
      },
      {
        title: "Marketplaces",
